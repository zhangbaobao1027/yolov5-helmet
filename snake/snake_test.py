...
def main():
    ...
    src = cv.imread("../data/images/20211213_160022.png", 0)
    init = getCircleContour((1047, 1085), (80, 110), N=200)

    src = cv.imread("../data/images/20211213_160627.png", 0)
    init = getCircleContour((1120, 1052), (50, 70), N=200)

    # src = cv.imread("../data/images/bus.jpg", 0)
    # init = getCircleContour((134, 439), (40, 50), N=200)

    # src = cv.imread("../data/images/zidane.jpg", 0)
    # init = getCircleContour((991, 164), (120, 150), N=200)
    # init = getCircleContour((567, 326), (126, 156), N=200)
    ...
    # Snake Model
    x, y, errs = snake(img, snake=init, alpha=0.015, beta=10, gamma=0.1, convergence=0.005)    # max_iter=5000,
